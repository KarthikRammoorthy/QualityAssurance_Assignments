...
public class GameBoard
{
	...
	private GameBoard()
	{
		...
		objSubject = new AsteroidImpactSubject();
	}
	...
	public void DoTick()
	{
		...
		{
			ArrayList<BoardComponent> row = GetBoard().get(i);
	...
	public void SubjectRegister(BoardComponent object)
	{
		objSubject.register(object);
	}
	
	public void SubjectUnRegister(BoardComponent object)
	{
		objSubject.unregister(object);
	}
	
	
	public void SubjectNotify(BoardComponent parent)
	{
		objSubject.notifyObservers(parent);
	}
